    ...
    <ion-content :scroll-events="true">
        <v-form header="PAD" action="/admin/bpm/run"> 
            <v-table 
                ...
                :filters="filters" src="/api/bpm/run"> 
            ...
            <template v-slot="{row,index}"> 
                ...
                <td width="220" header="Infractor">
                    ...
                    {{row.caso_infractor}} </td> 
<td width="40" class="center" header="">
                    <div :key="index+'_'+k" class="circle" :style="{border:'1px solid black',width:30,height:30,backgroundColor:row.activity?(row.activity.id?(row.activity.progress>100?'red':(getColor(row.activity))):'gray'):''}"></div></td>
